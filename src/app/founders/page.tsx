...
const founders = [
  ...
  },
  {
    name: "Saminul Islam",
    title: "CFO",
    bio: "Finance leader managing capital allocation and ensuring financial sustainability of our mission.",
    expertise: ["Finance", "Capital Management", "Strategic Planning"],
  },
  {
    name: "Ahad Ahmed",
    title: "CMO",
    bio: "Marketing strategist building brand awareness and connecting heRhealth's solutions to women worldwide.",
      ...
      <main className="flex flex-col">
        ...
        <section className="py-10 sm:py-16 px-4 sm:px-6 lg:px-8 bg-neutral-50">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="mb-3 sm:mb-4 text-2xl sm:text-4xl">Our Leadership Team</h1>
        ...
        <section className="py-10 sm:py-20 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-center mb-8 sm:mb-16 text-xl sm:text-3xl">Our Core Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
              {[
                ...
                <div key={value.title} className="p-4 sm:p-6 bg-white rounded-lg">
        ...
        <section className="py-10 sm:py-20 bg-neutral-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="mb-4 sm:mb-6 text-xl sm:text-3xl">Join Us on Our Mission</h2>
